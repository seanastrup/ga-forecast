...
output: 
  rmdformats::readthedown:
    includes:
      in_header: www/css_spinner.html
runtime: shiny
---
...
```{r echo=FALSE}
highcharter::highchartOutput('forecast') %>% shinycssloaders::withSpinner(type = 1)


output$forecast <- highcharter::renderHighchart({
